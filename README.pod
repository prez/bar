...
B<lemonbar> (formerly known as B<bar>) is a lightweight bar entirely based on XCB. Provides full UTF-8 support, basic formatting, RandR and Xinerama support and EWMH compliance without wasting your precious memory. This was forked from a version that supports setting a border and rotation, and introduces a fix for a buffering bug as well as WM_CLASS atom support.
...
Borders were introduced by dark-yux

Rotation was added by venam
